        ...
        stage('Enrich CSV VA Report') {
            steps {
                sh """
                    ...
                    python -u ./rpmVAenrichment.py Vulnerability_Report_2.0.csv Vulnerability_Report_RPM_Base_Images_2.0.csv
                """
                sh "curl -u ${PDUOSSVA_ARM_TOKEN} -X PUT -T Vulnerability_Report_RPM_Base_Images_2.0.csv https://arm.seli.gic.ericsson.se/artifactory/proj-cenm-va-reports-generic-local/aggregate_report/Vulnerability_Report_Base_Images_${PRODUCT_SET}.csv"
                archiveArtifacts artifacts: 'Vulnerability_Report_RPM_Base_Images_2.0.csv', allowEmptyArchive: true
            }
        }
    }
    post {
